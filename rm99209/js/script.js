...
//Impressão da primeira possição do array:
...
for (var i=0;i<nomesAlunos.length ; ++i){
    ...
    //Gerar um novo loop para interar o array e ao mesmo tempo
    //1 - Criar novos elementos na div
    //2 - Adicionar cafa um dos elementos e cada um dos elementos da div

    const divLista = document.getElementById("lista-nomes");

    //Utilizando o for of para interar o aarray
    ...
    //Inserir novos nomes no array, utilizando os metodos:
    ...
    console.log('Posição onde o elemento foi encontrado :',index );
        ...
        //Quebrar linha
        console.log("\n");
        //Alterando um elemento no array com o método splice e solicitando uma alteração
        //Imprimindo o array depois das alterações realizadas nos métodos acima:
